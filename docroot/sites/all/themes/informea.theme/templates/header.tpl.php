  ...
  <div class="container">
    ...
    <nav class="navbar-collapse collapse navbar-left" role="navigation">
      ...
      <ul class="nav navbar-nav" aria-hidden="true">
        ...
        <li><?php print l(t('Events'), 'search', array('query' => array('f[0]' => 'type:event_calendar', 'f[1]' => 'year_of_text:[1971 TO ' . date('Y') . ']', 'sort_bef_combine' => 'field_sorting_date DESC'), 'attributes' => array('class' => array('menu-title'), 'id' => 'events-menu-link'))); ?></li>
