...
<div class="panel <?php print $expanded ? 'panel-warning' : 'panel-default'; ?>">
    <div class="panel-heading indicator clearfix smallipop <?php print $expanded ? '' : ' collapsed' ;?> <?php print $highlight ? 'highlight' : '' ;?>" id="heading-<?php print $indicator->nid; ?>" data-toggle="collapse" data-target="#indicator-<?php echo $indicator->nid; ?>" aria-expanded="<?php print $expanded ? 'true' : 'false' ;?>">
      ...
      <?php if ($pw->body->value()): ?>
        <p><?php print($pw->body->value->value(array('decode' => FALSE))); ?></p>
      <?php endif; ?>
